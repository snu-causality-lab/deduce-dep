...
def complete_pc_stable_experiment(BN, K, alpha, ci_tester_name, working_dir, dataset_size, sampling_number=30):
    ...
    # experiment results
    _complete_pc_stable_experiment_core(BN, COLUMNS, K, alpha, dataset_size, reliability_criterions,
                                        sampling_number, working_dir, ci_tester=ci_tester)


def _complete_pc_stable_experiment_core(BN, COLUMNS, K, alpha, size_of_sampled_dataset, reliability_criterions, sampling_number,
    ...
    # print(f'_complete_pc_stable_experiment_core{(BN, COLUMNS, K, alpha, size_of_sampled_dataset, reliability_criterions, sampling_number, working_dir)}')
