...
def pc_stable_experiment(BN, ci_tester_name, working_dir, size_of_sampled_dataset, sampling_number, K, alpha):
    ...
    # experiment results
    _pc_stable_experiment_core(BN, COLUMNS, K, alpha, size_of_sampled_dataset, isdiscrete, reliability_criterions, sampling_number, working_dir, ci_tester=ci_tester)


def _pc_stable_experiment_core(BN, COLUMNS, K, alpha, size_of_sampled_dataset, isdiscrete, reliability_criterions, sampling_number, working_dir, ci_tester=None):
    result = []
